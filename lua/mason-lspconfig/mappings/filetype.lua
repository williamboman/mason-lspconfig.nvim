...
return {
  ...
  helm = { "helm_ls" },
  hoon = { "hoon_ls" },
  html = { "angularls", "antlersls", "ast_grep", "custom_elements_ls", "emmet_language_server", "emmet_ls", "html", "tailwindcss", "unocss" },
  ...
  javascript = { "ast_grep", "biome", "cssmodules_ls", "custom_elements_ls", "denols", "ember", "eslint", "glint", "quick_lint_js", "rome", "sourcery", "stylelint_lsp", "tailwindcss", "tsserver", "vtsls" },
  ...
  toml = { "taplo" },
  twig = { "tailwindcss" },
  typescript = { "angularls", "ast_grep", "biome", "cssmodules_ls", "custom_elements_ls", "denols", "ember", "eslint", "glint", "rome", "sourcery", "stylelint_lsp", "tailwindcss", "tsserver", "vtsls" },
